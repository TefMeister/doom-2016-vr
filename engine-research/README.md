# DOOM (2016) — VR Engine Research

Engine research toward a VR conversion of **DOOM** (2016) — built on
**id Tech 6** by id Software, published by Bethesda Softworks — with stereo
rendering and 6DOF head tracking as the goal.
...
always know where to look. You are in **doom-2016-vr-engine-research**.
...
| **doom-2016-vr-engine-research** ← you are here | Distilled engine reference (dossier) + reusable VR RE playbook. |
